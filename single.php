		...
		<?php if (have_posts()) : ?>
			...
			<?php while (have_posts()) : the_post(); ?>		
				...
				<div class="post-alt blog" id="post-<?php the_ID(); ?>">
					...
					<p class="post_date"><?php _e('Posted on','woothemes'); ?> <?php the_time('d F Y'); ?> by <a rel="nofollow" href="<?php bloginfo('url'); ?>/authors/<?php the_author_firstname(); ?>-<?php the_author_lastname(); ?>"><b><?php the_author_link(); ?></b></a>. <a rel="nofollow" href="<?php bloginfo('url'); ?>/author/<?php the_author_firstname(); ?>">More posts</a> from <?php the_author_firstname(); ?>. <span class="singletags"><?php if (function_exists('the_tags')) { ?><?php the_tags('Tags: ', ', ', ''); ?><?php } ?></span></p>
