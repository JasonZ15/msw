	...
	function woo_postnav() { 
		?>
	        <div class="post-entries">
	            <div class="post-prev fl"><?php previous_post_link( '%link', '<span class="meta-nav">&laquo; Previous Post</span>' ) ?></div>
	            <div class="post-next fr"><?php next_post_link( '%link', '<span class="meta-nav">Next Post &raquo;</span>' ) ?></div>
	            <div class="fix"></div>
	        </div>	
