       ...
       ?>  
 		...
 		<div id="tabs">
            ...
            <ul class="wooTabs">
                ...
                <?php if ($order <> "comments" && !$comments == "on") { ?><li class="comm"><a href="#tab-comm"><?php _e('Comments', 'woothemes'); ?></a></li><?php } ?>
                <?php if ($order <> "tags" && !$tags == "on") { ?><li class="tags"><a href="#tab-tags"><?php _e('Tags', 'woothemes'); ?></a></li><?php } ?>
            	<?php if ($order <> "subscribe" && !$subscribe == "on") { ?><li class="sub"><a href="#sub"><?php _e('Subscribe ', 'woothemes'); ?></a></li><?php } ?>
            </ul>
